...
// export default function LessonSection({ title = "Section 1" }) {
...
//                   <div>
//                     <p className="text-sm">lesson-video.mp4</p>
...
//   const lessonId = "temp-lesson-id"; // replace with real id after creation
...
//                     <button
//                       onClick={() =>
//                         replaceLessonVideo(lessonId, fileRef.current.files[0])
//                       }
...
//             {/* THUMBNAIL */}
//             <div>
//               <div className="w-32 lg:w-40 h-24 lg:h-28 bg-gray-300 rounded-lg flex items-center justify-center text-xs">
//                 Add thumbnail
//               </div>
//               <p className="text-[10px] text-center mt-1">
//                 Resolution - X - Px
