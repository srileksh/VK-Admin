...
videoName: "",
videoFile: null,
thumbnailFile: null, // store selected file only
thumbnailUrl: "", // cloud url after upload
videoUploaded: false,
isSaved: false,
saving: false,
errors: {},
...
/* THUMBNAIL SELECT (ONLY STORE FILE) */
...
/* THUMBNAIL UPLOAD (SHOW AFTER CLICK) */
...
{lessons.map((lesson) => ( <div
     ...
     >
{/* Header */} <div className="flex justify-between items-center border-b pb-2 mb-4"> <div className="flex items-center gap-2"> <span className="text-sm font-medium">{title}</span> <FaPen className="text-gray-400" /> </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <button
                ...
                disabled={!lesson.thumbnailFile || lesson.isSaved || uploadingThumbnailId === lesson.id || lesson.thumbnailUrl}
