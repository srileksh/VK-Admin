...
//                         />
//                       ) : (
//                         <MdAccountCircle size={35} className="text-gray-400" />
//                       )}
//                     </div>
              ...
              <div className="border border-[#a09f9f] rounded-lg p-4 h-[250px] mb-4 mt-2 flex flex-wrap gap-4">
                ...
                <div className="w-full">
                  <div className="flex flex-col sm:flex-row gap-3 items-center mt-4 px-6 md:px-0 lg:px-2.5">
                    ...
                    <div
                      onClick={() =>
                        !facultyUploading && fileInputRef.current.click()
                      }
                      className="relative w-18 h-18 rounded-full flex items-center justify-center cursor-pointer overflow-hidden"
                    >
                      {draftFaculty.profileImage ? (
                        <img
                          src={draftFaculty.profileImage}
                    ...
                    <div className="text-gray-600 flex flex-col items-center">
                      ...
                      >
                        {facultyUploading ? "Uploading..." : "Upload"}
                      </button>
                    </div>
